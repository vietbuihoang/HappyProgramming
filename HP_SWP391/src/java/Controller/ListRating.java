 ...
 * @author DELL
 */
public class ListRating extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListRating</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListRating at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        for(Rating r : dao.getRating()){
            if(r.getMenteeID()==user.getUserID()){
                listR.add(r);
            }
        }
        ...
        request.getRequestDispatcher("ListRating.jsp").forward(request, response);
    }
